...
# Модель данных для входных данных в запросе на вход в аккаунт
class SignInRequest(BaseModel):
    login: str
    password: str


# Измененный обработчик эндпоинта для входа в аккаунт пользователя
@app.post("/sign_in/")
async def authoriz_user(request: Request, user_data: SignInRequest):
